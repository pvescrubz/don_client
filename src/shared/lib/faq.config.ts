...
export const FAQ_CONFIG = {
  [APP_PAGES.HOME.slug]: [{ title: "HOME HOME", descr: "steam" }],
  [APP_PAGES.FAQ.slug]: [{ title: "FAQ", descr: "steam" }],
  ...
  [getName(APP_PAGES.BALANCE_PS.slug)]: [{ title: "SONY?", descr: "home" }],
  [getName(APP_PAGES.BALANCE_XBOX.slug)]: [{ title: "xbox?", descr: "home" }],
  [getName(APP_PAGES.BALANCE_XBOX.slug)]: [{ title: "xbox?", descr: "home" }],
